...
if (!fs.existsSync(dir)) {
    ...
    console.log("Example> node --experimental-modules src/core/config/scripts/generateConfig.js");
    process.exit(1);
}
...
`;
    fs.writeFileSync(
        path.join(dir, `modules/${module}.js`),
        code
    );
...
fs.writeFileSync(
    path.join(dir, "modules/OpModules.js"),
    opModulesCode
);
